...
public class WebServicePost {
    ...
    public static String executeHttpPost(Context context,String username, String password) {

        try {
            String path = PropertitesUtil.getNetConfigProperties(context.getApplicationContext()).getProperty("Login");
